            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                  <span className="text-base sm:text-xl font-bold tracking-tight text-[#1a1a1a] flex items-center gap-1.5 font-display truncate">
                    Memory Atlas
                  </span>
          ...
          <div className="flex items-center gap-2">
            ...
            {features.posterGenerator && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-800 dark:text-amber-300 border border-amber-500/30 text-xs font-bold transition-all cursor-pointer"
              >
            ...
            {features.landmarkPinning && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 text-xs font-semibold transition-all cursor-pointer"
              >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-[#2563eb] text-white text-xs sm:text-sm font-semibold rounded-xl hover:bg-[#1d4ed8] shadow-sm transition-all active:scale-95 cursor-pointer font-sans"
            >
